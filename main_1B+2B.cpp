...
void propagate_computation(int num_energy_levels, long double mass, long double x_min,
    ...
    std::string output_freq_filename = "freq_file_1B+2B.dat";
    std::string output_tdip_filename = "transition_dipole_1B+2B.dat";
    ...
    std::string NB_mu_filename = "1B+2B_dipole_surface.dat";
